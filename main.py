...
def setup_database(connection):
    ...
    try:
        ...
        cursor.execute("CREATE DATABASE IF NOT EXISTS maternal_health_management_system")
        connection.commit()
...
def add_sample_health_tips(connection):
    ...
    try:
        ...
        print(f"Error adding health tips: {err}")
...
def add_sample_hospitals(connection):
    ...
    try:
        ...
        print(f"Error adding hospitals: {err}")
...
def create_default_checkup_reminders(connection, user_id, due_date):
    ...
    try:
        ...
        print(f"Error creating checkup reminders: {err}")
...
class MaternalHealthApp:
    def __init__(self):
        ...
        # Initialize components with specific database selection
        try:
            ...
            print(f"Error initializing components: {err}")
